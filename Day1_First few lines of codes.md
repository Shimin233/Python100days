...
- By the rules of markdown, the codes can be quoted using two pairs of triple backticks; furthermore, adding `Python` just after the first set of triple quotes
